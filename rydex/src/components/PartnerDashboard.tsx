...
const STEPS: Step[] = [
    { id: 1, tittle: "Vehicle", route: "/partner/onboarding/vehicle" },
    { id: 2, tittle: "Documents", route: "/partner/onboarding/documents" },
    { id: 3, tittle: "Bank", route: "/partner/onboarding/bank" },
    { id: 4, tittle: "Review" },
    { id: 5, tittle: "Video KYC" },
    { id: 6, tittle: "Pricing" },
    { id: 7, tittle: "Final Review" },
    { id: 8, tittle: "Live" },
];
                    ...
                    <div className='relative min-w-[800px]'>
                        ...
                        <div className='relative flex justify-between'>
                            ...
                            ${completed
                                        ...
                                        <p className='mt-3 text-sm font-semibold text-center'>{s.tittle}</p>
                        ...
                        userData?.videoKycStatus === "approved" ? (
                            ...
                            <RejectionCard
                                ...
                                onAction={async () => {
                                    ...
                                    await axios.get("/api/partner/onboarding/video-kyc/request");
