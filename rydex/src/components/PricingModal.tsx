                ...
                >
                    ...
                    >
                        <div className='p-6 border-b'>
                            <h2 className='text-x1 font-bold'>Pricing and Vehicle Image</h2>
                        </div>
                        ...
                        <div className='p-6 space-y-6'>
                            ...
                            {/* image preview */}
                            <label htmlFor='imageLabel' className='relative h-44 border-2 border-dashed rounded-2xl flex
                        ...
                        <div className='p-6 border-t flex gap-3'>
                            <button className='flex-1 border rounded-2xl py-2' onClick={onClose}>Cancel</button>
                            <button
