        ...
        <div className='flex flex-col pt-5 pb-4 gap-3'>
            {
                isActive && (
                    <div className='mx-5 lg:mx-6 grid grid-cols-2 gap-2'>
                        <div className='bg-zinc-50 border border-zinc-200 rounded-2xl p-4 flex items-center shrink-0 gap-3'>
                                ...
                                <div className='flex gap-2 mt-2'>
                                    {
                                        booking.userMobileNumber && (
                                            <a
                                                ...
                                                className={`flex items-center justify-center border border-zinc-200 gap-2 bg-zinc-100 hover:bg-zinc-200 active:scale-[0.97] transition-all text-zinc-900 py-3 rounded-xl text-sm font-semibold ${canChat ? "flex-1" : "w-full"}`}
                                            >
                                                <Phone size={15} /> Call
                                            </a>
                                        )
