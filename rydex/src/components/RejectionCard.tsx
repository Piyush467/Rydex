    ...
    md:rounded-3xl p-5 sm:p-6 md:p-8 space-y-4'>
        ...
        text-sm sm:text-base'>
            ...
            {onAction && (
                <button
                    onClick={onAction}
                    className='w-full sm:w-auto px-6 py-2.5 bg-black
            rounded-xl text-white text-sm sm:text-base font-medium 
            hover:bg-gray-800 transition'>{actionLabel || "Try Again"}</button>)}
