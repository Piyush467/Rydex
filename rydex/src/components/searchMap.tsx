      ...
      <Polyline positions={route} pathOptions={{color:"#0a0a0a",weight:4,
        ...
        <AnimatePresence>
          {ready && km!==null && (
            ...
            className="absolute bottom-20 left-4 z-[500] flex items-center gap-2 bg-white border border-zinc-200
            px-3.5 py-2 rounded-xl shadow-lg"
            >
              ...
              <span className="text-zinc-900 text-xs font-bold">
                ~{Math.max(3,Math.round((km /25)* 60))}min</span>
