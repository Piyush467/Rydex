...
import { ArrowLeft, CheckCircle, CircleDashed, Clock, ImageIcon, IndianRupee, IndianRupeeIcon, ShieldCheck, Truck, XCircle } from 'lucide-react'
import type { vehicleTypes } from '@/models/vehicle.model'
        ...
        <div className='min-h-screen bg-gray-50'>
            ...
            <main className='max-w-7xl mx-auto px-6 py-12 grid lg:grid-cols-2 gap-12'>
                ...
                <div className='space-y-8'>
                    <AnimatedCard title={"Vehicle Details"}
                        icon={<Truck size={18} />} >
                        ...
                        <div className='flex justify-between text-sm'>
                            ...
                            <span className='font-semibold'>{data?.numberPlate || "-"}</span>
                        </div>
                        <div className='flex justify-between text-sm'>
                    ...
                    <AnimatedCard title={"Pricing Configuration"}
                    ...
                    {data?.status === "pending" && (
                        ...
                        >
                            ...
                            <div className='flex flex-col gap-4'>
                                <button
                                    className='py-3 rounded-2xl bg-gradient-to-r from-black to-gray-800
                        text-white font-semibold hover:opacity-90 transition' onClick={() => setShowApprove(true)}
                                >Approve</button>
                                <button
                                    className='py-3 rounded-2xl border font-semibold hover:bg-gray-100 transition' onClick={() => setShowReject(true)}
                                >Reject</button>
                            </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className='flex gap-3 mt-6'>
                                ...
                                <button className='flex-1 flex items-center justify-center py-2 rounded-xl bg-black text-white' onClick={handleApprove}
                    ...
                    >
                        ...
                        >
                            ...
                            <div className='flex gap-3 mt-6'>
                                ...
                                <button className='flex-1 flex py-2 items-center justify-center rounded-xl bg-black text-white'
                                    onClick={handleReject} disabled={approveLoading}> {rejectLoading ? <CircleDashed className='text-white animate-spin' /> : "Reject"}</button>
                            </div>
                        </motion.div>
