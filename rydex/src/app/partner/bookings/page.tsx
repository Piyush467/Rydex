    ...
    const getVehicleIcon = (vehicleType?: string) => {
        switch (vehicleType?.toLowerCase()) {
            ...
            case 'auto':
                ...
                ); // You can add Auto icon if available
        ...
        <div className='min-h-screen bg-gray-50'>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>
                <div className='max-w-3xl mx-auto'>
                    ...
                    text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500'
                        >
                            <option>All</option>
                    ...
                    {loading && (
                        <div className='flex justify-center py-16'>
                            <Loader2 className='animate-spin w-8  text-black-600' />
                        </div>
                    )}
                        ...
                        <div className='space-y-4'>
                            {filterBookings.map((b, i) => (
                                ...
                                shadow-sm hover:shadow:md transition-all overflow-hidden'>
                                        <div className='flex items-center gap-3 p-4 bg-linear-to-r from-blue-50
                                    to-indigo-50 border-b border-gray-20'>
                                            <div className='w-12 h-12 rounded-full overflow-hidden bg-blue-200
                                        flex-shrink-0 border-2 border-white shadow-sm flex items-center justify-center'>
                                            ...
                                            <div className='flex-1'>
                                                <div className='flex items-center justify-between'>
                                                    ...
                                                    ${getStatusColor(b.bookingStatus)}`}
                                        ...
                                        <div className='px-4 pt-3'>
                                            <div className='bg-gray-50 rounded-lg p-2 flex items-center gap-2'>
                                                ...
                                                <div className='text-xs text-gray-600'>
                                                    {b.vehicle.vehicleModel}  . {b.vehicle.numberPlate || "Not assigned"}
                                        ...
                                        <div className='p-4 space-y-3'>
                                            <div className='flex items-center gap-3'>
                                                <div className='flex-shrink-0 w-6 h-6 bg-green-100
                                        rounded-full flex items-center justify-center'>
                                            ...
                                            <div>
                                                <div className='flex items-center gap-3'>
                                                    <div className='flex-shrink-0 w-6 h-6 bg-red-100
                                        rounded-full flex items-center justify-center'>
                                    ...
                                    border-t border-gray-200'>
                                            <div className='flex items-center gap-2'>
                                                ...
                                                ${b.paymentStatus === "paid"
                                                        ...
                                                        : "bg-yellow-100 text-yellow-700"}`}>{b.paymentStatus}</span>
                                            ...
                                            font-medium text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100
