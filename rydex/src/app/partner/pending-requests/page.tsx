                                    ...
                                    <div className='flex flex-col justify-between lg:items-end gap-6 w-full lg:w-auto'>
                                        ...
                                        <div className='flex gap-4 w-full lg:w-auto'>
                                            <button
                                                ...
                                                className='flex-1 lg:flex-none px-6 py-3 rounded-xl bg-white border border-gray-300 text-gray-700 text-sm font-semibold hover:bg-gray-100
                                  transition-all duration-200 active:scale-[0.98] disabled:opacity-50'>
                                                Reject
                                            </button>
                                            <button
                                                onClick={() => handleAccept(b._id)}
                                                className='flex-1 lg:flex-none px-8 py-3 rounded-xl bg-black text-white flex items-center justify-center
                                    text-sm font-semibold shadow-md hover:bg-gray-900 transition-all hover:shadow-lg duration-200 active:scale-[0.98] disabled:opacity-50'>
                                                Accept Ride
                                            </button>
