...
function Page() {
    ...
    const handleDocs = async () => {
        ...
        try {
            ...
            formdata.append("aadharnumber", docs.aadhar);
            formdata.append("licencenumber", docs.license);
            formdata.append("rcnumber", docs.rc);
        ...
        <div className="min-h-screen bg-white flex items-center justify-center px-4">
            ...
            >
                <div className=" relative text-center">
                    <button
                        className="absolute left-0 top-0 w-9 h-9 rounded-full border border-gray-300 flex items-center justify-center
            hover:bg-gray-100 transition"
                ...
                <div className="mt-8 space-y-6">
                    ...
                    >
                        <div>
                            <p className="text-sm font-semibold">Adhar / ID Proof</p>
                            <p className="text-sm text-gray-500">Government Issued ID</p>
                        </div>

                        {docs.aadhar ? <span className="text-xs text-green-600 font-medium">Uploaded</span> : <div> <span className="text-xs text-gray-400">Upload</span>
                        ...
                        <input
                            ...
                            hidden
                            accept="image/*,.pdf"
                            onChange={(e) => handleImage("aadhar", e.target.files![0])}
                        />
                    </motion.label>
                    ...
                    >
                        ...
                        {docs.license ? <span className="text-xs text-green-600 font-medium">Uploaded</span> : <div> <span className="text-xs text-gray-400">Upload</span>
                            <div className="w-10 h-10 rounded-full bg-black text-white flex items-center justify-center">
                                <UploadCloud size={18} />
                            </div></div>}
                        <input
                            ...
                            hidden
                            accept="image/*,.pdf"
                            onChange={(e) => handleImage("license", e.target.files![0])}
                        />
                    </motion.label>
                    ...
                    >
                        ...
                        {docs.rc ? <span className="text-xs text-green-600 font-medium">Uploaded</span> : <div> <span className="text-xs text-gray-400">Upload</span>
                            <div className="w-10 h-10 rounded-full bg-black text-white flex items-center justify-center">
                                <UploadCloud size={18} />
                            </div></div>}
                        <input
                            ...
                            hidden
                            accept="image/*,.pdf"
                            onChange={(e) => handleImage("rc", e.target.files![0])}
                        />
                    </motion.label>
                </div>
                ...
                >
                    {loading ?
                        <CircleDashed className="text-white animate-spin" /> : "Continue"
                    }
                </motion.button>
            </motion.div>
        </div>
